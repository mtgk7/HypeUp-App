...
const PLATFORM_META: Record<string, { icon: React.FC<IconProps>, color: string, bg: string }> = {
  ...
  Telegram:  { icon: TelegramIcon,  color: "#2AABEE", bg: "#f0f8ff" },
  Facebook:  { icon: FacebookIcon,  color: "#1877F2", bg: "#f0f5ff" },
  Spotify:   { icon: SpotifyIcon,   color: "#1DB954", bg: "#f0fff4" },
  Discord:   { icon: DiscordIcon,   color: "#5865F2", bg: "#f5f3ff" },
  Pinterest: { icon: PinterestIcon, color: "#E60023", bg: "#fff5f5" },
};
